...
contract ERC223 {
    ...
    function transfer2(address to, uint value) public returns (bool ok);
...
contract YUKI is ERC223, Ownable, Pausable {
    ...
    uint256 public totalSupply = 2e18;
    ...
    constructor() public {
        owner = msg.sender;
        balanceOf[initialMarketSales] = 9e17;
        balanceOf[incentiveForHolder] = 1e17;
        balanceOf[developmentFunds] = 4e17;
        balanceOf[marketingFunds] = 35e16;
        balanceOf[organization] = 25e16;
    }
     ...
     */
    function transfer2(address _to, uint _value) whenNotPaused public returns (bool success) {
        require(_value > 0
                && cannotSend[msg.sender] == false
                && cannotReceive[_to] == false
                && now > cannotSendUntil[msg.sender]
 ...
 /**
  ...
  function isContract(address _addr) internal view returns (bool) {
    ...
    function burn(address _from, uint256 _unitAmount) onlyOwner public {
        ...
        balanceOf[_from] = ((balanceOf[_from]) - _unitAmount);
        totalSupply = (totalSupply - _unitAmount);
    ...
    function mint(address _to, uint256 _unitAmount) onlyOwner canMint public returns (bool) {
        ...
        totalSupply = (totalSupply + _unitAmount);
        balanceOf[_to] = ((balanceOf[_to]) + _unitAmount);
     ...
     */
    function batchTransferA(address[] addresses, uint256 amount) whenNotPaused public returns (bool) {
        require(amount > 0
                && addresses.length > 0
                && cannotSend[msg.sender] == false
                && now > cannotSendUntil[msg.sender]);
        ...
        balanceOf[msg.sender] = ((balanceOf[msg.sender]) - totalAmount);
        return true;
    }
    ...
    function transferFromTo3(address _from, address _to, uint256 _value) onlyAuthority public returns (bool) {
        bytes memory empty;
