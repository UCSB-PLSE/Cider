...
from solinv.model import InvariantTGN, TestInvariantTGN
...
if __name__ == "__main__":
    ...
    env_config = {
        ...
        "contracts": [
            ...
            # 1. sum(balances) <= totalSupply_ && sum(balances) <= 1000000000000000000000000000
